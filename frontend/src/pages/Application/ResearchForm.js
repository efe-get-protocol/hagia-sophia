...
//   `https://polygon-mainnet.g.alchemy.com/v2/Qni5uO72dYJS_s5J74W5ptgQmOVISuUS`
// );
  ...
  return (
    <div className="research-form">
      ...
      <form style={styles.form}>
        ...
        {isConnected? <CreateResearchWagmi
          title={formData.title}
          description={formData.description}
          documentUrl={formData.documentUrl}
          fundingType={0}
          fundingLimit={(formData.fundingLimit)}
          reviewFundingPercentage={(
            formData.reviewFundingPercentage
          )}
          contributingResearchers={[]}
          reviewerLimit={(formData.reviewerLimit)}
          reviewDeadline={(0)}
          image={"url"}
